...
function mostrarSweetAlert() {
	swal(
		'¡Compra realizada!',
		'Revise su casilla de correo electrónico para más detalles.',
		'success'
	).then(function () {
...
document
	.querySelector('form[action$="/purchasecart"]')
		...
		fetch(this.action, {
			...
			.then((response) => {
				if (response.ok) {
					...
					swal(
						'Error',
						'Hubo un problema al realizar la compra. Inténtelo de nuevo más tarde.',
						'error'
					);
				}
			})
